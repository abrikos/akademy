...
const modelSchema = new Schema({
        ...
        presidiumStatusId: {type: Number, label: 'Статус президиума', select: [{label: "Президент", value: 1}, {label: "Заместитель Президента", value: 2}, {label: "Вице-президент", value: 3}, {label: "Главный ученый секретарь", value: 4}, {label: "Советник", value: 5}]},
